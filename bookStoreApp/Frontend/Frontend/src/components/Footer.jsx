    ...
    <footer className="bg-gradient-to-r from-gray-700 via-gray-800 to-gray-900 text-gray-300 py-10">
      <div className="container mx-auto px-6">
        ...
        <div className="flex justify-center mb-6 space-x-6">
          <a className="text-lg font-semibold hover:text-pink-400 transition-colors duration-300" href="#">About Us</a>
          <a className="text-lg font-semibold hover:text-pink-400 transition-colors duration-300" href="#">Contact</a>
          <a className="text-lg font-semibold hover:text-pink-400 transition-colors duration-300" href="#">Jobs</a>
          <a className="text-lg font-semibold hover:text-pink-400 transition-colors duration-300" href="#">Press Kit</a>
        </div>
